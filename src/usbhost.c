...
uint8_t AnalyzeRootHub(void)
{
    ...
    {                                                      // Device exists
        ...
        {                                                 // A device is detected to be plugged in, but it has not been allowed, indicating that it has just been plugged in
        ...
        if (s == ERR_SUCCESS)
        {
            ...
            if (s == ERR_SUCCESS)
            {
                ...
                else // 其他设备
                {
                    ...
                    printlf();
                    printstr("if_subcls ");
                    printhex2(((PXUSB_CFG_DESCR_LONG)Com_Buffer)->itf_descr.bInterfaceSubClass);
                    printlf();
#endif
                    ...
                    {
#if DE_PRINTF
                        printx2(ThisUsbDev.DeviceVID);
                        printx2(ThisUsbDev.DevicePID);
                        printlf();
#endif
                    }
                }
